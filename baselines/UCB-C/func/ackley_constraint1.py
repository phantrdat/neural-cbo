...
class Ackley_Constraint1(BaseFunc):
    def __init__(
        self,
        xsize=10,
        zsize=10,
        ...
        super(Ackley_Constraint1, self).__init__(
            xdim, 
            zdim, 
            xsize, 
            zsize, 
        ...
        self.module_name = "ackley_constraint1"
        self.xsize = xsize
        self.zsize = zsize
    ...
    def get_noiseless_observation(self, xz):
        with torch.no_grad():
            ...
            val = 1 - (torch.linalg.norm(xz-1, ord=2, dim=-1) - 5.5)**2
